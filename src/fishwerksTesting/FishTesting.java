...
public class FishTesting{
    ...
    public void loadPage(){
    	// String url = "http://greatlakesconnectivity.org/login";
    	String url = "localhost:9000/login";
        driver.get(url);
    ...
    public void login(){
    	...
    	String pwd = "TeSt1nG";
    	WebElement emailBox = driver.findElement(By.xpath("/html/body/form/p[1]/input"));
    	WebElement pwdBox = driver.findElement(By.xpath("/html/body/form/p[2]/input"));
    	emailBox.sendKeys(email);
    	pwdBox.sendKeys(pwd);
    	assert(driver.getCurrentUrl().equals(anObject));
    }
